        ...
        <div class="form-inner">
          ...
          <el-form :model="ruleForm" :rules="rules" ref="ruleForm" @keyup.enter.native="submitForm('ruleForm')">
            <el-form-item prop="userName">
              ...
              <div class="icon-wrapper icon-wrapper-right" v-show="ruleForm.userName.length>0">
                <i class="iconfont iconfont-right icon-cross2 cursor-p"  @click="clearUserName"></i>
              </div>
            </el-form-item>
            ...
            <el-form-item prop="pswConfirm">
              <el-input v-if="pswConfirmVisiable" type="text" placeholder="请输入密码" v-model="ruleForm.pswConfirm"></el-input>
              <el-input v-else type="password" placeholder="请输入密码" v-model="ruleForm.pswConfirm"></el-input>
              <label class="icon-wrapper icon-wrapper-left">
                <i class="iconfont iconfont-right icon-suo"></i>
              </label>
            ...
            <el-form-item prop="icode" class="form-item-icode">
              ...
              <div class="icon-wrapper icon-wrapper-right icode-wrapper cursor-p" @click="getIcode" title="点击刷新">
