...
<script>
  ...
  export default {
    ...
    created(){
//      this.getServiceOrderList_Servicing()  //访问接口
    },
    computed:{
      ...mapState({
        serviceOrderListTotalAmount: state => state.serviceOrderList.serviceOrderServicingListTotalAmount,
        serviceOrderList: state => state.serviceOrderList.serviceOrderListServicing
      }),
